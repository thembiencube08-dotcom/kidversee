...
const footerLinks = {
  brand: [
    ...
    { label: 'Franchise Opportunities', href: '/pages/franchise' },
  ],
  quickLinks: [
    ...
    <footer className="bg-white">
      ...
      <div className="py-6">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="bg-[#fdf2f4] rounded-2xl px-6 py-5">
            <h2 className="text-sm font-bold text-gray-800 mb-3">Popular Categories</h2>
            <p className="text-sm text-gray-600 flex flex-wrap gap-1">
              {popularCategories.map((cat, i) => (
                <span key={cat.label} className="flex items-center">
                  <Link href={cat.href} target="_blank" rel="noopener noreferrer" className="hover:text-[#e21a5a] transition-colors">
                    {cat.label}
                  </Link>
      ...
      <div className="py-4 pb-8">
        <div className="max-w-[1400px] mx-auto px-4">
          <div className="bg-[#fdf2f4] rounded-2xl px-6 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
              ...
              <div className="lg:col-span-1">
                <h2 className="text-2xl font-bold text-[#e21a5a] leading-tight mb-4">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <input
                    ...
                    className="flex-1 bg-white border border-gray-200 rounded-full px-4 py-2.5 text-sm focus:outline-none focus:border-[#e21a5a] transition-colors"
                  />
              ...
              <div className="lg:col-span-2 grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                {/* Customer Support */}
                <div>
                  <h3 className="text-sm font-bold text-gray-800 mb-3">Customer Support</h3>
                  <ul className="space-y-2">
                ...
                {/* Company Info */}
                <div>
                  <h3 className="text-sm font-bold text-gray-800 mb-3">Company Info</h3>
                  <ul className="space-y-2">
              ...
              <div className="flex items-center gap-3">
                {socialLinks.map((social) => (
                  <Link
                    ...
                    className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-gray-700 hover:bg-[#e21a5a] hover:text-white transition-all duration-200 shadow-sm"
                  >
                    {social.icon}
                  </Link>
                ))}
      ...
      <div className="border-t border-gray-100 py-4">
        <div className="max-w-[1400px] mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-2">
          <p className="text-xs text-gray-500">
            &copy; 2026{' '}
            <Link href="/" className="hover:text-[#e21a5a] transition-colors">
              Popees Baby Care
            </Link>
            . All Rights Reserved.
          </p>
          <p className="text-xs text-gray-500">
            Designed by{' '}
            <Link
              href="https://maydayinternet.com/?utm_source=popees_website"
              target="_blank"
              rel="noopener noreferrer"
              className="font-medium hover:text-[#e21a5a] transition-colors"
            >
              Mayday Internet
            </Link>
          </p>
